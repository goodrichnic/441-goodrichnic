...
function squarePrintFuncDef(numDef) {
     let result = (numDef * numDef);
     console.log("The result is:" + result);
}
var squarePrintFuncExpress = function(numExp) {
     let result = (numExp * numExp);
     console.log("The result is:" + result);
};
